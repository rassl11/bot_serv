...
#     context.bot.send_message(text="{} Добро пожаловать в Timekeeper Service Bot, Отправь свой номер телефона".format(name), chat_id=user_id,
#                              reply_markup = ReplyKeyboardMarkup([phone],resize_keyboard=True,one_time_keyboard=True))
...
#         cur.execute(update_history.format(text, user_id))
...
#         context.bot.send_message(chat_id = user_id,text ='На чем будем курить?',reply_markup = ReplyKeyboardMarkup([kolaud,folga],resize_keyboard=True))
#
